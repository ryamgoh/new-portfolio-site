...
export default function Cursor() {
  ...
  useEffect(() => {
    ...
    function moveCursor(e: { clientX: any; clientY: any }) {
  ...
  return (
    <div
      ref={curs}
      className='cursor bg-secondary-600 pointer-events-none fixed left-1/2 top-1/2 z-[999] hidden h-3 w-3 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full sm:flex'
